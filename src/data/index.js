  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        name: "chat",
        title: "Chat",
        subtitle: "React, Ts, Express, Socket.io App Full Stack",
        description: [
          "SPA with CRA and Hooks",
          "Typescript in all app",
          "Login with username and room name",
          "Unlimited rooms and users per room",
          "Shows connected and disconnected users",
          "Soft Neumorphism Responsive design",
          "Light / Dark Mode",
        ],
        demoUrl: "https://chattin.netlify.app/",
      },
      // {
      //   name: "gnomefinder",
      //   title: "Gnome Finder",
